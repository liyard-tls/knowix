...
export default function DashboardPage() {
  ...
  const firstName = user.displayName?.split(' ')[0] ?? t.dashboard.greetingFallback
  ...
  return (
    <AppShell>
      <div className="flex flex-col gap-0">
        ...
        >
          <p className="text-sm text-[var(--text-muted)] mb-1">{t.dashboard.greeting(firstName)}</p>
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-sm text-[var(--text-muted)]">{t.common.days}</span>
            </div>
            <div className="h-4 w-px bg-[var(--border)]" />
            <div className="flex items-center gap-1.5">
              <Zap className="h-4 w-4 text-yellow-400" />
              <span className="text-sm font-semibold text-[var(--text-primary)]">{xp} {t.common.xp}</span>
          ...
          {coursesLoading ? (
            ...
            >
              <Card variant="elevated" className="text-center py-10">
                ...
                <p className="text-[var(--text-secondary)] font-medium mb-1">{t.dashboard.empty.title}</p>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <ProgressBar value={done} max={total} size="sm" className="mt-3" />
                    </Card>
                  </motion.div>
                )
              })}
